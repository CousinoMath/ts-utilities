...
describe('ListWalker', () => {
    ...
    it('traversing', () => {
        ...
        // lw2 = [4, 3, 2, 1]:[]
        let lw2 = lw.moveAhead().moveAhead().moveAhead().moveAhead();
    ...
    it('(insert|remove)Ahead', () => {
        ...
        const lw2 = lw.moveAhead().moveAhead().moveAhead();
        expect(lw.insertAhead(0)).toEqual(fromList(0, 1, 2, 3));
        expect(lw.removeAhead()).toEqual(fromList(2,3));
        expect(lw2.insertAhead(4)).toEqual(fromList(1,2,3,4).moveAhead().moveAhead().moveAhead());
